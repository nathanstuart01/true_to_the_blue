...
class Game(BaseModel, table=True):
    ...
    home_team: Optional["Team"] = Relationship(sa_relationship_kwargs={"foreign_keys": [home_team_id]})
    away_team: Optional["Team"] = Relationship(sa_relationship_kwargs={"foreign_keys": [away_team_id]})
